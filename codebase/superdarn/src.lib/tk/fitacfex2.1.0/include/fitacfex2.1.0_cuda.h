#ifndef FITACFEX2.1.0_CUDA_H
#define FITACFEX2.1.0_CUDA_H
...
/* Core fitacfex2.1.0 CUDA Functions */
cudaError_t fitacfex2.1.0_process_cuda(
    cuda_array_t *input_data,
    cuda_array_t *output_data,
    void *parameters
);

cudaError_t fitacfex2.1.0_process_ranges_cuda(
...
/* Utility Functions */
bool fitacfex2.1.0_cuda_is_available(void);
int fitacfex2.1.0_cuda_get_device_count(void);
const char* fitacfex2.1.0_cuda_get_error_string(cudaError_t error);
...
} fitacfex2.1.0_cuda_profile_t;

cudaError_t fitacfex2.1.0_cuda_enable_profiling(bool enable);
cudaError_t fitacfex2.1.0_cuda_get_profile(fitacfex2.1.0_cuda_profile_t *profile);

#ifdef __cplusplus
}
#endif

#endif /* FITACFEX2.1.0_CUDA_H */
