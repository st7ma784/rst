#ifndef OLDGTABLEWRITE.1.4_CUDA_H
#define OLDGTABLEWRITE.1.4_CUDA_H
...
/* Core oldgtablewrite.1.4 CUDA Functions */
cudaError_t oldgtablewrite.1.4_process_cuda(
    cuda_array_t *input_data,
    cuda_array_t *output_data,
    void *parameters
);

cudaError_t oldgtablewrite.1.4_process_ranges_cuda(
...
/* Utility Functions */
bool oldgtablewrite.1.4_cuda_is_available(void);
int oldgtablewrite.1.4_cuda_get_device_count(void);
const char* oldgtablewrite.1.4_cuda_get_error_string(cudaError_t error);
...
} oldgtablewrite.1.4_cuda_profile_t;

cudaError_t oldgtablewrite.1.4_cuda_enable_profiling(bool enable);
cudaError_t oldgtablewrite.1.4_cuda_get_profile(oldgtablewrite.1.4_cuda_profile_t *profile);

#ifdef __cplusplus
}
#endif

#endif /* OLDGTABLEWRITE.1.4_CUDA_H */
