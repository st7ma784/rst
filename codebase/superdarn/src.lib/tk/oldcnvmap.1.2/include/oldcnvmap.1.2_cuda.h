#ifndef OLDCNVMAP.1.2_CUDA_H
#define OLDCNVMAP.1.2_CUDA_H
...
/* Core oldcnvmap.1.2 CUDA Functions */
...
cudaError_t oldcnvmap.1.2_process_ranges_cuda(
...
const char* oldcnvmap.1.2_cuda_get_error_string(cudaError_t error);
...
} oldcnvmap.1.2_cuda_profile_t;

cudaError_t oldcnvmap.1.2_cuda_enable_profiling(bool enable);
cudaError_t oldcnvmap.1.2_cuda_get_profile(oldcnvmap.1.2_cuda_profile_t *profile);

#ifdef __cplusplus
}
#endif

#endif /* OLDCNVMAP.1.2_CUDA_H */
